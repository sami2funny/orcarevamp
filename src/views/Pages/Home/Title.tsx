	...
	return (
		...
		>
			...
			<Canvas padding={{ top: 24, left: 24 }}>
				<Label index={0} text="feds" font={Enum.Font.GothamBlack} size={20} position={px(0, 0)} />
				...
				<Label index={4} text="richie0866/feds" position={new UDim2(0, 0, 1, -40)} transparency={0.45} />
			</Canvas>
		</Card>
	);
}
